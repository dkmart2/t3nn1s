    ...
    try:
        ...
        for t in tournaments:
            ...
            if tournament_key is not None:
                tournament_dict[str(tournament_key)] = t
...
class BayesianTennisModel:
    ...
    def simulate_match(self, player1_priors, player2_priors, best_of=3, tiebreak_sets=[1, 2, 3]):
        """Monte Carlo match simulation with Bayesian priors"""
        wins = 0
...
# ============================================================================
# DATA GENERATION AND CACHE FUNCTIONS
# ============================================================================
...
def get_top_confidence_matches(target_date, top_n=5, min_confidence=0.05):
    ...
    for match in matches:
        p1_canonical = normalize_name_canonical(match['player1_name'])
        p2_canonical = normalize_name_canonical(match['player2_name'])
